 ...
 * Policy:
 * <ul>
 * <li>Empty/null handling is delegated to @NotEmpty in AppCorsProperties.</li>
 * <li>Each non-wildcard value must be a valid HTTP(S) origin without
 * path/query/fragment/user-info.</li>
 * <li>Wildcard "*" is allowed only when it is the single configured entry.</li>
 * </ul>
 */
